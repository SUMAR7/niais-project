...
def extract_contours(after_preprocess):
    contours, hierarchy = cv2.findContours(after_preprocess, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)
...
class PlateFinder:
    ...
    def find_possible_plates(self, input_img):
        ...
        possible_plate_contours = extract_contours(self.after_preprocess)
